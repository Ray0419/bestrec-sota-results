...
\item \textbf{Internal evidence, prospective same-user validation, and a mechanism boundary.}
...
clearing its pre-declared +0.000500 practical threshold with validation-only selection and
sealed final evaluation. It is prospective, but remains same-investigator,
same-code-lineage, same-Amazon-family evidence under local same-user custody---not
