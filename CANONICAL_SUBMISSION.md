...
- Results of record: `_bestrec_run/results_SOTACONF_V2_*.json` (+ tracked sidecars +
  ...
  rank sidecars, and checkpoints remain private and are represented by hashes.
