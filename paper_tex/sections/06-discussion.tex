...
The main result is deliberately modular and narrowly identified. Positive FIR--identity contrasts on three outcome-visible categories show that the residual arm improves this backbone in the tested settings. Shared and parameter-matched nonlinear causal controls recover similar gains without learned per-channel FIR taps. However, no active lag-0 or pointwise parameter-matched non-temporal placebo was run, so these studies do not isolate temporal structure from generic trainable-residual capacity. They establish neither a universal frequency-filter benefit nor a new end-to-end architecture. All breadth and control studies are internal, outcome-known evidence rather than external-comparator or independent-confirmation evidence.
