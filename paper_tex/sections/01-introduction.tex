...
recomputes 196 reported cells across 20 claim families, environment-caveated comparator
...
\item \textbf{Internal evidence, frozen same-team robustness, and a mechanism boundary.}
Learned FIR--identity estimates are positive on three outcome-known category/split settings.
