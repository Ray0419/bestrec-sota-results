...
for S in 20260609 20260610 20260611 20260612; do
  ...
  _bestrec_run/.venv/Scripts/python -u _bestrec_run/run_sasrec_sbert.py Video_Games \
    ...
    --causal-filter --filter-kernel 8 --eval-every 10 \
    --out _bestrec_run/results_V1b_causalfilter_k8_seed${S}_VG.json \
    > _bestrec_run/run_V1b_causalfilter_k8_seed${S}_VG.log 2>&1
  echo "=== V1b SEED $S DONE ==="
done
echo "=== V1b ALL SEEDS DONE ==="
