...
for S in 20260609 20260610 20260611 20260612; do
  ...
  _bestrec_run/.venv/Scripts/python -u _bestrec_run/run_sasrec_sbert.py Musical_Instruments \
    ...
    --label-smoothing 0.2 --causal-filter --filter-kernel 8 --eval-every 2 \
    --out _bestrec_run/results_MI_V2_ls02_filter8_seed${S}.json \
    > _bestrec_run/run_MI_V2_ls02_filter8_seed${S}.log 2>&1
  echo "=== MI-V2 SEED $S DONE ==="
done
echo "=== MI-V2 ALL SEEDS DONE ==="
