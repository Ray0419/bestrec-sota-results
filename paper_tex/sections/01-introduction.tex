...
recomputes 190 reported cells across 17 claim families, environment-caveated comparator
...
\item \textbf{Matched internal evidence and an active-control boundary.} Learned
...
independent confirmation. On Musical\_Instruments, shared and parameter-matched
nonlinear causal controls also improve identity and are not separated from learned taps;
this narrows the supported mechanism to causal temporal mixing rather than uniquely
learned per-channel FIR coefficients. A frequency-5-heavy Musical\_Instruments
