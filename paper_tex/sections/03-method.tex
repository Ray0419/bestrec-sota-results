...
A separate, subsequently frozen Software attempt also evaluated the canonical K=16 form prospectively and returned a positive practical-effect verdict; its same-investigator, same-code-lineage, same-Amazon-family, local-custody scope still precludes independent-confirmation wording (\S\ref{sec:5.2}).
