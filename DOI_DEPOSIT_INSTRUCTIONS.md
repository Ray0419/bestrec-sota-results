...
1. https://zenodo.org/uploads/new → upload the **current** bundle `bestrec_deposit_v1.1.6.zip`
   (from the `v1.1.6-deposit` release assets, or `_release/` locally).
