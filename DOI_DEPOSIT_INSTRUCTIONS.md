...
1. https://zenodo.org/uploads/new → upload the **current** bundle `bestrec_deposit_v1.1.5.zip`
   (from the `v1.1.5-deposit` release assets, or `_release/` locally).
