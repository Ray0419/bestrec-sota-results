...
recomputes 177 reported cells across 16 claim families, environment-caveated comparator
...
one small causal filtering component survives matched controls and transfers without
...
\item \textbf{Matched internal evidence with a fixed transfer test.} The learned FIR
separates from identity on Musical\_Instruments (+0.002265, 95\% CI [0.001928,
0.002602]) and transfers with one untuned configuration to
Industrial\_and\_Scientific (+0.002110 [0.001820, 0.002399]) and
CDs\_and\_Vinyl (+0.006150 [0.005849, 0.006450]) (\S\ref{sec:5.2}). These are
filter-versus-identity contrasts, not external-comparator or distributional-superiority
results. A frequency-5-heavy Musical\_Instruments text-tail effect is secondary and
does not establish cross-dataset heterogeneity (\S\ref{sec:5.3}--\S\ref{sec:5.4}).
