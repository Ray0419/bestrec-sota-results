> **HISTORICAL DOCUMENT (preserved verbatim).** This README describes the repository's
> earlier LC2C / SBERT-EASE cold-item line of work (releases up to
> `bestrec-raw-records-v1`). It is **not** the current paper. The current project —
> *Pre-Registered, Artifact-Gated Evaluation for Sequential Recommendation* — is described
> in the root [README.md](README.md). Nothing below is claimed by the current manuscript.
