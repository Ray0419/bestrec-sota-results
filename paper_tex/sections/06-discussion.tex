...
Together they show that the residual arm improves this backbone in the tested settings.
...
The evidence establishes neither per-channel-tap necessity, a universal frequency-filter benefit, nor a new end-to-end architecture.
