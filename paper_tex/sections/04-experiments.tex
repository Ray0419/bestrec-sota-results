...
placebo. Training constructed maps from TRAIN+VALID without opening or hashing TEST
bytes. After all 96 training runs completed, each selected checkpoint received one
sealed TEST evaluation. The primary estimand was NDCG@10 on rating-at-least-4 events
