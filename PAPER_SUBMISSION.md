...
- **Category scope**: the headline causal-FIR evidence uses Video_Games and Musical_Instruments; Beauty_and_PC supports the tail-pattern null; Office_Products is descriptive unless repaired (VOID under its prereg floor check, Appendix A.0). Other categories untested.
